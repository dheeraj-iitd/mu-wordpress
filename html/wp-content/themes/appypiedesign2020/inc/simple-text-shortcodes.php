<?php 
/* Custome content with short code */
...
class Shortcodes_Manager {
	...
	public function register_shortcode(){
		add_shortcode( 'text_block', function( $atts, $content ){
			...
			return apply_filters( 'the_title', $shortcode_post->post_content );
	...
	public static function set_admin_column_content( $column_name, $post_id ) {
		if ( 'shortcode' === $column_name ) {
			echo '<p>[text_block id='. $post_id .' description="' . get_the_title( $post_id ) . '"]</p>';
		}
	}
}
